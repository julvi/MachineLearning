...
dattmp<-datStandard[,11:28]*(1/sqrt(9)) 
datStandard[,11:28] <- dattmp
...
labels[7] <- "Z score"
labels[9] <- "Unique 15mers in template"
labels[10] <- "Unique 15mers in query"
labels[13] <- "Unclassified phages"
labels[19] <- "Unclassified dsDNA phages"
labels[20] <- "Escherichia coli"
labels[22] <- "Lactococcus lactis"
labels[23] <- "Mycobacterium smegmatis"
labels[24] <- "Pseudomonas aeruginosa"
labels[25] <- "Staphylococcus aureus"
labels[27] <- "Prochlorococcus marinus"
labels[28] <- "Vibrio cholerae"
...
labels <- c("U. 15mers in q.","Phage genome size","U. 15mers in t.","Phage GC content", "Expected value","Score","Z-score","coverage","frac_d","frac_q")
corrgram(datMout[,1:10], order=TRUE, lower.panel=panel.cor,
